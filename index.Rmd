...
prices %>% 
  ...
  labs(colour = "Price\ndirection",
       ...
       title = "Overall price trends by state (2021/01 - 2022/05)", 
...
The plots below show the historical price trends of key commodities. The fluctuations in the prices of onions and tomatoes have been historically much more volatile. The last time prices saw a major drop was in the 2009 economic crisis.  Palm oil, on the other hand, has seen a recent and very acute increase in prices. This is also true, to a lesser extent, for pulses. 

<br>

```{r plot-historical-prices, fig.height=6.5}
...
In states such as Mon, Tanintharyi and Kayin, the seasonal rise and dip in prices is observed particularly clearly in the prices of onions. In Magway and Kayah, prices are still seasonal, but fluctuate to a much greater extent. However, it is clear that the fluctuations in the prices of tomatoes do not have much historical precedent. 
...
Shan (East), Sagaing and Shan (North), all notable for their higher than average prices across all commodities
...
Whilst inflation has not been as catastrophic as it has been in Sri Lanka, if the crisis in Myanmar is prolonged, food shortages are likely as global supply chain issues exist and countries continue to impose export bans to shore up domestic supplies. Furthermore, Myanmar has limited foreign currency it can use as a buffer. 
...
At this stage, emergency stockpiling is not yet necessary, though given the fragility of the context in Myanmar, a major crisis may be sparked off by a change in the conflict or the onset of a major natural disaster. 

There is little, programmatically, to be done about inflation. Aid agencies have neither the capacity nor the mandate to stabilise markets, though they may choose to invest in community resilience to help affected persons better weather these shocks and stresses. 
...
### 5.2 Interactive reference table 
